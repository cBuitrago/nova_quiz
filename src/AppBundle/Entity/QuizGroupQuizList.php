 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\QuizGroupQuizListRepository")
 * @ORM\HasLifecycleCallbacks
 */
class QuizGroupQuizList {
    ...
    public function setQuizGroupID($quizGroupId) {
        $this->quizGroupId = $quizGroupId;
        return $this;
    }

    public function getQuizGroupID() {
